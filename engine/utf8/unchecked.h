...
namespace utf8
{
    namespace unchecked
    {
        ...
        uint32_t next(octet_iterator& it)
        {
            ...
            typename std::iterator_traits<octet_iterator>::difference_type length = utf8::internal::sequence_length_cp(cp);
            switch (length) {
                case 1:
                    break;
                case 2:
        ...
        // The default iterator class implementation
        template <typename octet_iterator, typename iterator_category>
        ...
        // iterator class partial specialization for input iterators
        template <typename octet_iterator>
        ...
        // class iterator - delegates to internal::iterator
